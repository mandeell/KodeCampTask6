...
def hash_password(password: str) -> str:
    ...
    salt = "shopping_cart_salt"  # Should be random and stored securely in production
...
def register_user(username: str, password: str, role: UserRole = UserRole.CUSTOMER, email: str = None):
    """Register a new user"""
    users = load_users()
